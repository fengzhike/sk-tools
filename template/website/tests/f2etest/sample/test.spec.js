...
module.exports = function(){
    ...
    it('click: wd ( #kw, 85, 8, 0 )', async function(){
        await driver.sleep(300).wait('#kw', 30000)
               .sleep(300).mouseMove(85, 8).click(0);
    });

    it('sendKeys: f2etest', async function(){
        await driver.sendKeys('f2etest');
    });

    it('click: 百度一下 ( #su, 30, 14, 0 )', async function(){
        await driver.sleep(300).wait('#su', 30000)
               .sleep(300).mouseMove(30, 14).click(0);
    });
